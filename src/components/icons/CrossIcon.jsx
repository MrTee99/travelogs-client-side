...
const CrossIcon = ({ Size, Fill, ...props }) => {
    return (
        <svg className={props.className} fill={Fill} width={Size} height={Size}  viewBox="0 0 365.71733 365" xmlns="http://www.w3.org/2000/svg">
